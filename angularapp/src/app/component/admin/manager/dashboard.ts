...
export class ManagerDashboard implements OnInit {
  ...
  loadBlockedAdmins() {
    ...
    this.http.get(`${environment.apiUrl}/admins/blocked`).subscribe({
      next: (admins: any) => {
  ...
  unblockAdmin(admin: any) {
    ...
    this.http.post(`${environment.apiUrl}/admins/unblock/${admin.id}`, {}).subscribe({
      next: (response: any) => {
        if (response.success) {
  ...
  resetAnyAdminPassword() {
    ...
    this.http.post(`${environment.apiUrl}/admins/reset-password/${this.selectedAdminForPasswordReset.id}`, {
  ...
  resetAdminPassword() {
    ...
    this.isResettingPassword = true;
    this.http.post(`${environment.apiUrl}/admins/reset-password/${this.selectedBlockedAdmin.id}`, {
      newPassword: this.newPassword
    }).subscribe({
      next: (response: any) => {
        if (response.success) {
  ...
  loadManagerAccessibleFeatures() {
    ...
    this.allAdmins.forEach(admin => {
      this.http.get(`${environment.apiUrl}/admins/feature-access/${admin.email}`).subscribe({
        next: (response: any) => {
  ...
  loadAllAdmins() {
    ...
    this.http.get(`${environment.apiUrl}/admins/all`).subscribe({
      next: (admins: any) => {
  ...
  createDefaultManager() {
    ...
    this.http.post(`${environment.apiUrl}/admins/create-default-manager`, {}).subscribe({
      next: (response: any) => {
        if (response.success) {
  ...
  saveFeatureAccess() {
    ...
    this.http.post(`${environment.apiUrl}/admins/feature-access/${adminEmail}`, {
  ...
  createAdminEmployee() {
    ...
    this.http.post(`${environment.apiUrl}/admins/create`, this.newAdmin).subscribe({
      next: (response: any) => {
  ...
  updateInvestment(investmentId: number, updates: any) {
    this.http.put(`${environment.apiUrl}/investments/${investmentId}`, updates).subscribe({
      next: (response: any) => {
        if (response.success) {
  ...
  updateFixedDeposit(fdId: number, updates: any) {
    this.http.put(`${environment.apiUrl}/fixed-deposits/${fdId}`, updates).subscribe({
      next: (response: any) => {
        if (response.success) {
