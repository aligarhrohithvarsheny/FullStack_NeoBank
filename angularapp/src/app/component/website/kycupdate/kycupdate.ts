...
export class Kycupdate implements OnInit {
  ...
  checkIfOtpRequired() {
    ...
    this.http.get(`${environment.apiBaseUrl}/api/kyc/check-existing/${this.userProfile.accountNumber}`).subscribe({
      next: (response: any) => {
  ...
  loadExistingPanFromAccount() {
    ...
    this.http.get<any>(`${environment.apiBaseUrl}/api/users/account/${this.userProfile.accountNumber}`).subscribe({
      next: (userData: any) => {
  ...
  loadPanFromApprovedKyc() {
    ...
    this.http.get<any[]>(`${environment.apiBaseUrl}/api/kyc/account/${this.userProfile.accountNumber}/all`).subscribe({
  ...
  sendKycOtp() {
    ...
    this.http.post(`${environment.apiBaseUrl}/api/kyc/send-otp`, {
  ...
  uploadDocuments() {
    ...
    this.http.post(`${environment.apiBaseUrl}/api/kyc/upload-documents`, formData).subscribe({
      next: (response: any) => {
        if (response.success) {
  ...
  requestToAdmin() {
    ...
    this.http.post(`${environment.apiBaseUrl}/api/kyc/create`, requestData).subscribe({
      next: (response: any) => {
