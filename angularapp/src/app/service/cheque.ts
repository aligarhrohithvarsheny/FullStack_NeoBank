...
export class ChequeService {
  private apiUrl = `${environment.apiBaseUrl}/api/cheques`;
  ...
  // Request OTP for cheque draw - User (sends OTP to registered email)
  requestChequeDrawOtp(id: number): Observable<any> {
    return this.http.post<any>(`${this.apiUrl}/${id}/request-otp`, {});
  }

  // Request cheque drawing - User (include otp in request to verify)
