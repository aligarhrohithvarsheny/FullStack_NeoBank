...
public class TransferService {
    ...
    // Save transfer with global transaction ID
    public TransferRecord saveTransfer(TransferRecord transfer) {
        // Assign global transaction sequence if not already set
        if (transfer.getGlobalTransactionSequence() == null) {
            transfer.setGlobalTransactionSequence(transactionIdGenerator.getNextTransactionId());
        }
