...
public class PositivePayService {
    ...
    public List<Map<String, Object>> eligibleCheques(String accountNumber, Long claimedUserId) {
        ...
        for (Map<String, Object> item : result) {
            ...
            item.put("positivePayStatus", requestRepository.findFirstByAccountNumberAndChequeNumberAndStatusIn(accountNumber, number, activeRegistrationStatuses())
    ...
    public PositivePayResponse create(PositivePayCreateRequest input, Long claimedUserId, String ip) {
        ...
        if (requestRepository.findFirstByAccountNumberAndChequeNumberAndStatusIn(input.accountNumber(), input.chequeNumber(), activeRegistrationStatuses()).isPresent()) throw new IllegalArgumentException("Positive Pay registration already exists for this cheque");
