...
public class EducationLoanSubsidyClaim {
    ...
    // Uploaded document path (relative) and extracted text
    private String documentPath; // Path to uploaded PDF/JPG/JPEG

    @Column(length = 4000)
    private String extractedText; // Text extracted from uploaded document (if any)
