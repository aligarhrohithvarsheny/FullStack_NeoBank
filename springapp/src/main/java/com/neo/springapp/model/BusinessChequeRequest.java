...
/**
 * BusinessChequeRequest Model - Current/Business Account Cheque Draw Requests
 * Mirrors the salary account cheque draw system for business accounts
 */
@Entity
@Table(name = "business_cheque_requests", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"cheque_number", "current_account_id"}),
    @UniqueConstraint(columnNames = {"serial_number", "current_account_id"})
})
public class BusinessChequeRequest {
    ...
    private String status; // PENDING, APPROVED, REJECTED, COMPLETED, CANCELLED, CLEARED
    ...
    // Constructors
    public BusinessChequeRequest() {
    }

    public BusinessChequeRequest(Long userId, Long currentAccountId, String chequeNumber, String serialNumber,
    ...
    public Boolean getChequeDownloaded() { return chequeDownloaded; }
    public void setChequeDownloaded(Boolean chequeDownloaded) { this.chequeDownloaded = chequeDownloaded; }

    public LocalDateTime getChequeDownloadedAt() { return chequeDownloadedAt; }
    public void setChequeDownloadedAt(LocalDateTime chequeDownloadedAt) { this.chequeDownloadedAt = chequeDownloadedAt; }
    ...
    public Boolean getPayeeAccountVerified() { return payeeAccountVerified; }
    public void setPayeeAccountVerified(Boolean payeeAccountVerified) { this.payeeAccountVerified = payeeAccountVerified; }

    public String getPayeeAccountType() { return payeeAccountType; }
    public void setPayeeAccountType(String payeeAccountType) { this.payeeAccountType = payeeAccountType; }
    ...
    public String getCreditedToAccount() { return creditedToAccount; }
    public void setCreditedToAccount(String creditedToAccount) { this.creditedToAccount = creditedToAccount; }
