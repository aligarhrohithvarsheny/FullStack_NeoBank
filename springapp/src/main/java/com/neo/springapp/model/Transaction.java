...
public class Transaction {
    ...
    private Long globalTransactionSequence; // Global unique transaction sequence across entire bank
    ...
    // For branch/credit transactions: account from which amount was debited (source)
